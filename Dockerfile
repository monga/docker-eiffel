...
RUN REPO=http://cdn-fastly.deb.debian.org && \
    ...
    apt-get -yq update && apt-get install -yq eatmydata && eatmydata apt-get -yq upgrade && \
    eatmydata apt-get -yq install curl bzip2 make gcc libxtst-dev libgtk2.0-dev && eatmydata apt-get clean && rm -rf /var/lib/apt/*
RUN curl -L https://ftp.eiffel.com/pub/download/18.01/Eiffel_18.01_gpl_101424-linux-x86-64.tar.bz2 | tar xj -C /opt

# Define Eiffel environment variables
ENV ISE_EIFFEL /opt/Eiffel_18.01
